...
sigma3 = sigma1 * 3.9;
sigmaT = 2.5;
Gaus3d_1 = Gaussian3D([Azimuth,Elevation],0,0.5*[sigma1, sigma1, sigmaT],5);
Gaus3d_2 = Gaussian3D([Azimuth,Elevation],0,0.5*[sigma2, sigma2, sigmaT],5);
Gaus3d_3 = Gaussian3D([Azimuth,Elevation],0,0.5*[sigma3, sigma3, sigmaT],5);
