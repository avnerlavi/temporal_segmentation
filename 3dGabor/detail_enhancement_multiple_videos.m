...
video_in_folder = [root ,'/resources/material_from_ynon_19_1_22/filtered/'];
video_out_folder = [root ,'/results/material_from_ynon_19_1_22_edited_results/filtered_higher_threshold/'];
if(explicit_filenames)
    ...
    video_names = {'eye_c.c/0258_0352.mp4', ...
        ...
        'heart_malformation/0858_0906.mp4',...
        'heart_malformation/1018_1029.mp4',...
        'heart_malformation/1401_1409.mp4',...
        'heart_malformation/1627_1746.mp4',...
        'heart_malformation/1756_1832.mp4',...
        'heart_malformation/2711_2737.mp4',...
        'heart_malformation/2805_2818.mp4',...
        };
else
...
DE_params.activationThreshold = 0.24; %for running man - 0.3
